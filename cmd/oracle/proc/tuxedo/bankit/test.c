...
36,0,0,2,47,0,4,27,0,0,2,1,0,1,0,2,97,0,0,1,3,0,0,
};
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select ENAME into :b0  from emp where empno=:b1";
